...
path=$wwwIPADir/$projectName$(date +%Y%m%d%H%M%S)$buildConfig.ipa
...
curl -X PUT --data "changelog=$changelog" http://fir.im/api/v2/app/5a153561548b7a073a0001c7?token=c3ce49d69a7bb7914fb757792644841a
echo "\n打包上传更新成功！"
rm -rf $buildAppToDir
